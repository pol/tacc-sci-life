...
#Updated GFFDB.pm from release 1.
...
Source:     http://yandell.topaz.genetics.utah.edu/maker_downloads/9F9C/CA4E/CDA2/5D313A0C55438B9042DA104E4399/%{name}-%{version}.tgz
Packager:   TACC - jfonner@tacc.utexas.edu
# This is the actual installation directory - Careful
# buildroot should be set in the include files.  I'm going to remove it here
# B uildRoot:  /var/tmp/%{name}-%{version}-buildroot
