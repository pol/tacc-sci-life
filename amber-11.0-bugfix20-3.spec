...
Source:    amber11-bugfix20.tar.gz
...
tar xzvf /home1/0000/build/rpms/SOURCES/%{PNAME}%{version_unit}-bugfix20.tar.gz
...
Your ibrun line will change depending your filenames, etc. Also make sure that
the cuda/4.0 module is loaded as well if you are using GPUs.  Again, visit
