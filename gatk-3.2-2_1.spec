...
Name: gatk
#Illegal char '-' in version if it is 3.2-2
Version: 3.2.2
Release: 1
License: MIT License
Vendor: Broad Institute
Group: Applications/Life Sciences
Source: GenomeAnalysisTK-3.2-2.tar.bz2
...
For more information:  http://www.broadinstitute.org/gatk/guide/version-history
