...
setenv ( "G4NEUTRONHPDATA",    "%{INSTALL_DIR}/data/G4NDL4.2")
setenv ( "G4ABLADATA",    "%{INSTALL_DIR}/data/G4ABLA3.0")
setenv ( "G4REALSURFACEDATA",    "%{INSTALL_DIR}/data/RealSurface1.0")
setenv ( "G4NEUTRONXSDATA",    "%{INSTALL_DIR}/data/G4NEUTRONXS1.2")
setenv ( "G4PIIDATA",    "%{INSTALL_DIR}/data/G4PII1.3")
setenv ( "G4SAIDXSDATA",    "%{INSTALL_DIR}/data/G4SAIDDATA1.1")
