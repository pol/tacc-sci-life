...
Source:     cufflinks-%{version}.Linux_x86_64.tar.gz
...
help (
[[
This module loads the %{name} Linux x86-64 binary from the developer.
This module makes available the %{name} executable. Documentation for %{name} is available online at the publisher website: http://cufflinks.cbcb.umd.edu/
