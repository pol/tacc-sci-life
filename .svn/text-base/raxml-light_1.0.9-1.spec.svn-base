...
RAxML-Light (Randomized Axelerated Maximum Likelihood) is a lightweight program for sequential and parallel Maximum Likelihood based inference of large phylogenetic trees.  It has less functionality than RAxML, but may be run in parallel using MPI.
...
local help_message = [[
The RAxML-Light modulefile defines the following environment variables, TACC_RAXML_LIGHT_DIR, TACC_RAXML_LIGHT_BIN, and TACC_RAXML_LIGHT_DOC for the location of the RAxML-LIGHT directory, binaries, and documentation.
...
whatis("Keywords: Biology, Application, Phylogenetics, 2012Q3")
