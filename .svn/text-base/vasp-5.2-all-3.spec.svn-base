...
Group:     Application
Source:    vasp.5.2_all_TACC.tar.gz
Packager:  TACC - hliu@tacc.utexas.edu
Buildroot: /var/tmp/%{name}-%{version}-buildroot


%define version_unit 52
...
make -f Makefile_Ranger_VASP52_std_hliu clean
make -f Makefile_Ranger_VASP52_std_hliu
mv vasp vasp_std

make -f Makefile_Ranger_VASP52_gamma_hliu clean
make -f Makefile_Ranger_VASP52_gamma_hliu
mv vasp vasp_gamma


make -f Makefile_Ranger_VASP52_ncl_hliu clean
make -f Makefile_Ranger_VASP52_ncl_hliu
mv vasp vasp_ncl

cd ../vasp.5.2.vtst

make -f Makefile_Ranger_VASP52_std_vtst_hliu clean
make -f Makefile_Ranger_VASP52_std_vtst_hliu
mv vasp vasp_std_vtst

make -f Makefile_Ranger_VASP52_gamma_vtst_hliu clean
make -f Makefile_Ranger_VASP52_gamma_vtst_hliu
mv vasp vasp_gamma_vtst


make -f Makefile_Ranger_VASP52_ncl_vtst_hliu clean
make -f Makefile_Ranger_VASP52_ncl_vtst_hliu
