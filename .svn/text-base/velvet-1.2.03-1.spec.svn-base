...
make CC=icc CXX=icpc 'CFLAGS=-openmp -m64' 'MAXKMERLENGTH=96' cleanobj zlib obj velveth velvetg
...
%install
mkdir -p $RPM_BUILD_ROOT/%{INSTALL_DIR}
cp -R ./velvetg ./velveth ./shuffleSequences_fasta.pl ./shuffleSequences_fastq.pl ./contrib ./data ./Columbus_manual.pdf ./Manual.pdf $RPM_BUILD_ROOT/%{INSTALL_DIR}
