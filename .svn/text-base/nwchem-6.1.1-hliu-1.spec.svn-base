#
# $Id: nwchem-611.spec,2012/10/04 hliu $
#
...
Source:    Nwchem-6.1.1-src.2012-06-27.tar.gz
...
ln -s $RPM_BUILD_DIR/%{name}-%{version} /tmp/nwchem-6.1.1

export NWCHEM_TOP=/tmp/nwchem-6.1.1
...
export PYTHONHOME=/opt/apps/python/epd/7.2.2
