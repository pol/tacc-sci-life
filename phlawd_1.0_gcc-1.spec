...
Source: phlawd-%{version}_gcc.tar.gz
...
local help_message = [[
The PHLAWD module file makes available the PHLAWD executable and 
the associated helper apps used to build phylogeny assemblies. 
The moudle defines the following environment variables: 
