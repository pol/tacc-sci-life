# need --define 'is_gcc46 1' to run rpmbuild on lonestar, gcc47 on stampede
...
%define GEANT4_DATADIR /scratch/projects/tacc/bio/%{name}/9.6.p02
...
sed -i -e "56,66s@\$geant4_envbindir\/..\/share\/Geant4-10.0.0\/data@%{GEANT4_DATADIR}@g" geant4.sh

cd $RPM_BUILD_ROOT/%{INSTALL_DIR}/share/Geant4-10.0.0/geant4make
sed -i -e "175,190s@\$geant4make_root\/..\/data@%{GEANT4_DATADIR}@g" geant4make.sh
